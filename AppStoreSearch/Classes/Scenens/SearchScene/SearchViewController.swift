...
class SearchViewController: UIViewController {
    ...
    private let termRelay = BehaviorRelay<String?>(value: nil)
    ...
    private func setupDataSource() {
        ...
        let titleForHeaderInSection: RxTableViewSectionedAnimatedDataSource<TermSectionModel>.TitleForHeaderInSection = { (dataSource, indexPath) in
...
//            .disposed(by: disposeBag)
    ...
    private func bindViewModel() {
        let input = ViewModelType.Input(viewReload: viewReloadRelay.asObservable(),
                                          term: termRelay.asObservable().unwrap(),
                                          search: searchRelay.asObservable().unwrap()) //초기화
